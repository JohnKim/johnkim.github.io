...
현재 모바일 서비스 전반의 서비스 기획, UI/UX 디자인, 앱과 서버 API 개발 및 운영을 담당하고 있습니다.

오랫기간 S/W 아키텍트로 다양한 프로젝트와 R&D 과제를 수행했던 경험을 해왔으며, 이 경험을 바탕으로 현재도 아키텍처 설계 및 시스템 구조개선을 위해 직접 설계와 개발을 하고 있습니다.
